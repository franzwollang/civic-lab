...
1. **FAQ → artifact** (About pattern already proven)  
...
5. **Home CONCEPT links** / CONCEPT rewrite (docs-heavy)  
...
- Next: **FAQ artifact migration** (OPEN_ISSUES §1; About done as `canon-about`).
