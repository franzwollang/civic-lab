...
1. ~~**Home CONCEPT links**~~ (**done** — `#what-is-this` + `HOME_EXEMPLARS`; `smoke-home-preamble`)
2. **CONCEPT.md rewrite** (docs-heavy editorial pass)
...
- Next: **CONCEPT.md rewrite pass** (OPEN_ISSUES §1; home exemplars done).
