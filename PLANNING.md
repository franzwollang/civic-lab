...
**Next build:** **M6 Claims + lanes** (`in progress` — Claim table + immutable lanes + adjudication scaffolding landed). Next: claim authoring UX. Accepted Risk on leaf stays M7.
...
| **M6 — Claims + lanes** | `in progress` | Claim table + profile legality ✓; immutable Manual lanes ✓; adjudication scaffolding (status sets + queue + global adjudicators) ✓; claim authoring UX remaining |
