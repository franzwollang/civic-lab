...
**Next build:** **M5 Threads + RFC** (`in progress` — Thread/Post/Target ✓; Section sync ✓; leaf + wrapper promote + RevSet ✓; leaf decide + parent cascade ✓; remaining: Collection merge authority, reply composer). Optional Manuals 3D globe deferred.
...
| **M5 — Threads + RFC** | `in progress` | Thread/Post/Target ✓; Section DB sync ✓; leaf + wrapper RFC promote + RevSet→proposal revision ✓; leaf Merge/Reject/Park + parent decided cascade ✓; remaining: Collection merge authority, reply composer |
