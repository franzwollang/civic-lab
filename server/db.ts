...
import { appendAuditLog, listActiveBoardHides, type AuditLogRow, type BoardHideRow } from "./db/moderationDb";
...
// —— Barrel re-exports (leaf modules) ————————————————————————————————

export { setPrisma, getPrisma } from "./db/prisma";
export {
  getAttributions,
  putAttributions,
  getTerms,
