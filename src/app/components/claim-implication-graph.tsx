...
export function ClaimImplicationGraph({ claims }: Props) {
  ...
  return (
    <div
      className="mb-4 rounded-lg border border-emerald-100 bg-gradient-to-br from-emerald-50/40 via-white to-sky-50/30 p-4"
          ...
          return (
            ...
            >
              ...
              <div className="space-y-2">
                <p className="text-[10px] font-semibold uppercase tracking-wider text-sky-800 lg:hidden">
                  Implies forecasts
                </p>
                {targetIds.map((tid) => {
